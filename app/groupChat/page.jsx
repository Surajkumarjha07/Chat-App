        ...
        <>
            <section>
                ...
                <section className='h-screen w-screen overflow-hidden'>
                    <Image src={'https://wallpaperaccess.com/full/2224392.png'} width={500} height={500} alt='Group Chat' className='h-screen w-full fixed' />
                    ...
                    <div className={`my-div flex flex-col items-end space-y-4 h-[530px] w-full overflow-y-scroll fixed right-7 top-20 px-3 py-2 font-black`}>
                        {
                            receiveMsgArray.map(({ msg, email }, index) => (
                                email === sendingemail ?
                                    <div key={index} className='bg-green-400 w-fit self-end mt-10 mr-10 rounded-md px-3 py-2 font-medium'>
                                        {msg}
                                    ...
                                    <div key={index} className='bg-green-400 ml-32 self-start w-fit mt-10 rounded-md px-3 py-2 font-medium'>
                                        {msg}
                                        <p className='text-xs text-gray-600 text-end'>
                                            {
                                                time.getHours() + ':' + time.getMinutes()
